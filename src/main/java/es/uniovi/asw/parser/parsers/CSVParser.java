...
public class CSVParser implements ReadCensus {
	...
	public List<Voter> read(String fileName) {
		...
		try {
			...
			wreportR.log("Error al leer el fichero CSV: " + e.getMessage());
		} 
			...
			try {
				...
				wreportR.log("ERROR CSVParser - Error cerrar I/O: " + e.getMessage());
			}
		}
	...
	private void addVoter(List<Voter> voters, String[] voter) {
		...
		try {
			...
			wreportR.log("ERROR CSVParser: el archivo no tiene el formato correcto");
		}
